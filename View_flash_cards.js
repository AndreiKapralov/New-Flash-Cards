  ...
  askNextQuestion() {
    ...
    if (question) {
      ...
      inquirer
        ...
        .then((answer) => {
          if (
            this.quizController.checkAnswer(
            ...
            console.log(
              `Уа уа уа уа(грустный трамбон) Беня не доволен! Правильный ответ : ${question.answer}\n`
            );
          }
          this.currentQuestionIndex++;
          this.askNextQuestion();
      ...
      console.log(
        `Красава ${this.userName}, ты ответил на ${this.score} из ${this.quizController.questions.length} вопросов, так держать!`
      );
    }
  }
}
